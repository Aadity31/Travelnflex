...
export default function MapSection({ name }: { name: string }) {
 ...
 <div className="pointer-events-none absolute bottom-14 left-3 bg-white/95 p-2 sm:p-3 rounded-lg shadow-lg border border-gray-200 max-w-xs">
    <div className="flex items-center gap-2 mb-1">
      <span className="w-2 h-2 rounded-full bg-green-500"></span>
      <span className="text-[10px] font-bold text-gray-500 uppercase">
        Start
      </span>
      <span className="text-xs sm:text-sm font-bold">Haridwar</span>
    </div>
    <div className="h-3 border-l-2 border-dashed border-gray-300 ml-[3px] my-0.5" />
    <div className="flex items-center gap-2 mt-1">
      <span className="w-2 h-2 rounded-full bg-red-500"></span>
      <span className="text-[10px] font-bold text-gray-500 uppercase">
        End
      </span>
      <span className="text-xs sm:text-sm font-bold">Badrinath</span>
    </div>
  </div>
</div>
