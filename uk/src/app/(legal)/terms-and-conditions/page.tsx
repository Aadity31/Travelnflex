...
export const metadata = {
  title: "Terms & Conditions | APS Groups",
  description:
    "Terms and Conditions of APS Groups Private Limited. Learn the rules, responsibilities, and legal framework for using our platform under Indian law.",
};
              ...
              components={{
                h2: ({ node, ...props }) => {
                  ...
                  return (
                    <h2
                      id={id}
                      className="scroll-mt-24 border-b pb-1"
                      {...props}
                    />
                  );
                },
