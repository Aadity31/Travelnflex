...
export default function QuickSearchBar() {
  ...
  return (
    <section className="relative bg-gradient-to-b from-transparent via-gray-50/50 to-gray-50 pt-16 pb-8 -mt-20">
      {/* Background Pattern */}
      ...
      <div className="relative z-20 max-w-6xl mx-auto px-4">
        <div className="bg-white rounded-2xl shadow-2xl p-5 md:p-6 border border-gray-100">
